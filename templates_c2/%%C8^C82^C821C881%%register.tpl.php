<?php /* Smarty version 2.6.22, created on 2012-12-30 15:24:08
...
<tr>
	...
	<td colspan = 1><input type="text" name="user_id" size=20 value = <?php echo $this->_tpl_vars['user_id']; ?>
><font size=2>※5文字～12文字の半角英数字、アンダーライン。</font></td>
</tr>
<tr>
	<td align=center nowrap>ユーザー名</td>
	<td colspan = 1><input type="text" name="user_name" size=20 value = <?php echo $this->_tpl_vars['user_name']; ?>
></td>
</tr>
<tr>
