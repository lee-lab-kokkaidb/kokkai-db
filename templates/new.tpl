...
<tr>
	...
	<td colspan = 3><input type="text" name="user_id" size=20 value = {$user_id}><font size=2>※5文字～12文字の半角英数字、アンダーライン。</font></td>
</tr>
<tr>
	<td align=center nowrap>ユーザー名</td>
	<td colspan = 3><input type="text" name="user_name" size=20 value = {$user_name}></td>
</tr>
